...
/* harmony import */ var context_template_recommend__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(1450);
/* harmony import */ var next_dynamic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(25237);
...
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(86752);
/* harmony import */ var _utils_get_base_url__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(32070);
/**
...
const TemplateCentre = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(null, {
    loadableGenerated: {
        modules: [
            "template/[category_code]/index.tsx -> " + "pc/components/template_centre/template_centre"
        ]
    },
    ssr: false
});
const TemplatePreview = next_dynamic__WEBPACK_IMPORTED_MODULE_5___default()(()=>Promise.all(/* import() */[__webpack_require__.e(627), __webpack_require__.e(4088), __webpack_require__.e(4523), __webpack_require__.e(6991), __webpack_require__.e(2520), __webpack_require__.e(4106), __webpack_require__.e(8682), __webpack_require__.e(5420)]).then(__webpack_require__.bind(__webpack_require__, 85420)), {
    loadableGenerated: {
        modules: [
            "template/[category_code]/index.tsx -> " + "pc/components/template_centre/template_preview"
        ]
    },
    ssr: true
});
const App = (props)=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(TemplateCentre, {
            children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(context_template_recommend__WEBPACK_IMPORTED_MODULE_4__/* .TemplateRecommendContext.Provider */ .G.Provider, {
                value: {
                    recommendData: props.templateRecommendData
                },
                children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(context_template_list__WEBPACK_IMPORTED_MODULE_3__/* .TemplateListContext.Provider */ .J.Provider, {
                    value: {
                        templateListData: props.templateList
                    },
                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(TemplatePreview, {})
                })
            })
        })
    });
...
const getServerSideProps = async (context)=>{
    ...
    if (categoryCode === _apitable_core__WEBPACK_IMPORTED_MODULE_1__.ConfigConstant.TEMPLATE_UNCATEGORIZED) {
        return {
            props: {}
        };
    }
    (axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.baseURL) = (0,_utils_get_base_url__WEBPACK_IMPORTED_MODULE_8__/* .getBaseUrl */ .S)(context);
    const headers = (0,_utils_utils__WEBPACK_IMPORTED_MODULE_7__/* .getRequestHeaders */ .D)(context);
    const userMeRes = await _apitable_core__WEBPACK_IMPORTED_MODULE_1__.Api.getUserMe({}, false, headers);
    ...
    if (categoryCode === "tpc000") {
        const res = await _apitable_core__WEBPACK_IMPORTED_MODULE_1__.Api.templateRecommend(headers);
        ...
        const res1 = await _apitable_core__WEBPACK_IMPORTED_MODULE_1__.Api.getTemplateCategories(categoryCode, headers);
        const { success: success1 , data: data1  } = res1.data;
        if (success1) {
            return {
                props: {
                    templateList: data1,
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "J": () => (/* binding */ TemplateListContext)
/* harmony export */ });
 ...
 * along with this program.  If not, see <http://www.gnu.org/licenses/>.
 */ 
const TemplateListContext = (0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({
    templateListData: {}
});
...
module.exports = require("dingtalk-design-libs");
...
module.exports = require("dingtalk-jsapi");
...
var __webpack_exports__ = __webpack_require__.X(0, [5237,7105,6791,202], () => (__webpack_exec__(56082)));
