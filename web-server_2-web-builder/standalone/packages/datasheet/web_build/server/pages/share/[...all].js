...
/* harmony import */ var _utils_get_base_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(32070);
var __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([pc_hooks__WEBPACK_IMPORTED_MODULE_4__]);
pc_hooks__WEBPACK_IMPORTED_MODULE_4__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];
/**
...
const DynamicComponentWithNoSSR = next_dynamic__WEBPACK_IMPORTED_MODULE_3___default()(null, {
    loadableGenerated: {
        modules: [
            "share/[...all].tsx -> " + "../../src/pc/components/share/share"
        ]
    },
    ssr: false
});
...
const getServerSideProps = async (context)=>{
    (axios__WEBPACK_IMPORTED_MODULE_2___default().defaults.baseURL) = (0,_utils_get_base_url__WEBPACK_IMPORTED_MODULE_6__/* .getBaseUrl */ .S)(context);
    if (!context.req?.url) {
        return {
            props: {}
        };
    }
    const shareId = (0,pc_hooks__WEBPACK_IMPORTED_MODULE_4__/* .getRegResult */ .UX)(context.req.url, pc_hooks__WEBPACK_IMPORTED_MODULE_4__/* .shareIdReg */ .Lb);
    if (!shareId) {
        return {
            props: {}
        };
    ...
    const res = await _apitable_core__WEBPACK_IMPORTED_MODULE_1__.Api.readShareInfo(shareId, headers);
...
var __webpack_exports__ = __webpack_require__.X(0, [5237,7105,627,4088,4523,6791,6991,2520,4106], () => (__webpack_exec__(5191)));
